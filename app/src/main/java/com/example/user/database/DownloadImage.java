 ...
 */
public class DownloadImage extends Activity implements View.OnClickListener {
    ...
    public void createTable() {
        System.out.println("Inside create table function");
    ...
    public void setImage(byte[] byteImage2) {
